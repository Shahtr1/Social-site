...
class Message {
	...
	public function getConvos(){
		...
		foreach($convos as $username){
			...
			$return_string .= "<a href='messages.php?u=$username'> <div class='user_found_messages'> <img src='" .$user_found_obj->getProfilePic() . "' style ='border-radius: 5px; margin-right: 5px;'> 
