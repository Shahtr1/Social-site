...
if(isset($_POST['post_message'])){
 ...
 ?>
    ...
    <ul class="nav nav-tabs" role="tablist" id="profileTabs">
      <li class="nav-item">
        <a class="nav-link active" href="#newsfeed_div" aria-controls="newsdeed_div" role="tab" data-toggle="tab">Newsfeed</a>
      </li>
      <li class="nav-item">
	      ...
	      <div class="modal-body">
	        ...
	        <form class="profile_post" action="" method="POST">
	        	<div class="form-group">
	        		...
	        		<input type="hidden" name="user_from" value="<?php echo $userLoggedIn; ?>"></input>
	        		<input type="hidden" name="user_to" value="<?php echo $username; ?>"></input>
